      ...
      >
        ...
        <div className="p-4">
          <Link href="/dashboard/contracts/new">
            <Button className="w-full bg-teal-600 hover:bg-teal-700 text-white rounded-xl shadow-[2px_2px_0px_rgba(0,0,0,0.1)] gap-2">
        ...
        <div className="p-4 border-t border-slate-100">
          <Link
            ...
            className="flex items-center gap-2 text-xs text-slate-400 hover:text-teal-600 transition-colors"
          >
