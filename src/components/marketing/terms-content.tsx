...
/**
 * Lista de chaves das 8 seções dos Termos de Serviço.
 * Cada seção possui título (sectionXTitle) e conteúdo (sectionXContent)
 * mapeados no namespace 'terms' do arquivo de traduções.
 */
...
/**
 * TermsContent — conteúdo completo da página de Termos de Serviço.
 *
 * Estrutura:
 * - Cabeçalho com título e data da última atualização
 * - Parágrafo introdutório
 * - 8 seções legais numeradas, cada uma com título e conteúdo
 *
 * Design: Light Neobrutalism — card único centralizado com max-w-3xl,
 * fundo branco, borda slate-200, sombra 3px 3px, cantos 2xl.
 * Tipografia limpa com espaçamento generoso entre seções.
 */
export function TermsContent() {
  /** Hook de traduções do namespace 'terms' */
