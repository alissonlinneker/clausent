...
/**
 * Conteúdo client-side da página de Pricing.
 *
 * Inclui:
 * - PricingSection completo (reutiliza o componente)
 * - Seção de FAQ com accordion animado
 *
 * Extraído do page.tsx para permitir que a página exporte metadata estático
 * (metadata só funciona em server components).
 */
